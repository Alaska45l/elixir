...
<style>
  ...
  .qty button { background: rgba(45,42,36,0.05); color: var(--color-emerald-dark); border: 0; border-radius: 6px; min-width: 72px; height: 46px; }
  .item-total { display: block; margin-top: 8px; color: var(--color-gold-dark); font-size: .9rem; }
